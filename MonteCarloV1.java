/**
 * PROGRAM DESCRIPTION: This program should simulate the Marco Polo method
 * on the example of trying to observe a bear in the nature.
 * AUTHORS: Daniel Kral
 * DATE: 17/11/2018
 */
...
//        System.out.println("The file path is: " + filePath);
        ...
        if(nOfTrials < minTrials) {
            ...
            while(nOfTrials < minTrials && wrongInputs < wrongInputsAllowed) {
                ...
                if(leftAttempts > 1) {
                    System.out.print("s"); // make this SG/PG friendly
                }
                System.out.println(" left.");
                wrongInputs++;
                System.out.println("Please enter desired number of trials (1000 and more): ");
                nOfTrials = Integer.parseInt(input.nextLine());
                System.out.println();
            }
            if(nOfTrials < minTrials) {
...
//        System.out.println("totalSpace = " + totalSpace);
        ...
        System.out.println("The average number of other animals observed \n" +
                "in between seeing two bears is: " + average);

        System.out.println();
        System.out.println("We hope you enjoyed our program.");
        ...
        reopen.write("Not sure if that's commitment or insanity, but let's give you the benefit of doubt and go with the former.");
        for(int i = 0; i < 400; i++) {
            reopen.write(" ");
        }
        reopen.write("Really?! Well I guess I should've gone with the latter. ");
        reopen.write("Nvm, just go and play around with it yourself: https://github.com/microhyd/AP-CSA-05.06-MarcoPoloMethod");
